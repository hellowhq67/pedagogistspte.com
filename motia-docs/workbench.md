...
The **Editor** tab lets you modify state values directly in the Workbench. Edit the JSON, hit **Save Changes**, and your update is persisted immediately. This is incredibly useful for:
