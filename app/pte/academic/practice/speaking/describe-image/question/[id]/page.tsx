    ...
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
          Describe Image Practice — Question {id.slice(0, 8)}
        </h1>
        {question.difficulty && (
      ...
      <div className="flex items-center justify-between gap-3 border-t pt-6">
        <div className="flex items-center gap-2">
          <Button asChild variant="outline">
            <Link href="/pte/academic/practice/speaking/describe-image">
              ← Back to List
            </Link>
          </Button>
        </div>
        ...
        <div className="flex items-center gap-2">
          <Button asChild variant="outline">
            <Link
              href={`/pte/academic/practice/speaking/describe-image/question/${id}`}
            >
              Redo
            </Link>
          </Button>
    ...
    <div className="bg-background min-h-screen">
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <nav className="text-muted-foreground mt-4 flex items-center gap-2 text-sm">
          ...
          <span>/</span>
          <Link
            href="/pte/academic/practice/speaking/describe-image"
            className="hover:text-primary"
          >
            Describe Image
          </Link>
