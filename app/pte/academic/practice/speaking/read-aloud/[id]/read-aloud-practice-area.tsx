...
interface ReadAloudPracticeAreaProps {
  questionId: string
}

export default function ReadAloudPracticeArea({
  questionId,
}: ReadAloudPracticeAreaProps) {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Record your reading of the prompt text.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Your recorded response will be analyzed for pronunciation, fluency, and content.
