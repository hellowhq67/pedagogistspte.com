  ...
  return [
    {
      ...
      description:
        'Full-length practice test covering all PTE Academic sections',
      duration: 180,
          ...
          questions: [
            {
              ...
              instructions:
                'You will see a text on the screen. Read it aloud as naturally and clearly as you can.',
              duration: 40,
              status: 'completed',
              score: 82,
            ...
            },
            {
              ...
              instructions:
                'You will hear a sentence once. Repeat it exactly as you hear it.',
              duration: 15,
              status: 'completed',
              score: 75,
              userAnswer: 'Sample response...',
          ...
          questions: [
            {
              ...
              instructions:
                'Read the passage below and summarize it using only one sentence.',
