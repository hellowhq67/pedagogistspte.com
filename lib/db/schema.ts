...
// User Subscriptions table - MOVED TO schema-lessons.ts
// This table has been consolidated in schema-lessons.ts with enhanced fields
// including tier, stripeSubscriptionId, stripeCustomerId, etc.
...
export const usersRelations = relations(users, ({ one, many }) => ({
  ...
  // subscriptions: many(userSubscriptions), // Moved to schema-lessons.ts
...
// userSubscriptionsRelations moved to schema-lessons.ts
...
// UserSubscription types moved to schema-lessons.ts
